...
const QUERY_LABELS: { test: RegExp; label: string }[] = [
  ...
  { test: /"granola" AND "Stephenson"/, label: "Stephenson" },
  ...
  { test: /"granola" AND "MCP"/, label: "MCP" },
  { test: /"granola" AND "\$125 million"/, label: "$125M raise" },
  { test: /"granola" AND "\$43 million"/, label: "$43M raise" },
  { test: /"granola" AND "Series B"/i, label: "Series B" },
  { test: /"granola" AND "Lightspeed"/, label: "Lightspeed" },
  { test: /"granola app"/, label: "granola app" },
  { test: /"try granola"/, label: "try granola" },
  { test: /"granola does"/, label: "granola does" },
  { test: /"granola ai"/, label: "granola ai" },
  ...
  { test: /"granola" AND "Otter"/, label: "vs Otter" },
  { test: /"granola" AND "Fathom"/, label: "vs Fathom" },
  { test: /"granola" AND "Fireflies"/, label: "vs Fireflies" },
