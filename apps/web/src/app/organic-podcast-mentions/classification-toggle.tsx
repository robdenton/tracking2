  ...
  const options: { value: Classification; label: string; title: string }[] = [
    {
      value: "product",
      label: "Credible only",
      title: "Episodes the AI classified as referring to Granola the product",
    },
    {
      value: "unclassified",
      label: "Awaiting review",
      title: "Episodes not yet classified by the AI",
    },
    {
      value: "all",
      label: "Show all",
      title: "Include food / ambiguous classifications too",
    },
  ];
